...
import type { CSSRuleObject, PluginCreator, KeyValuePair } from 'tailwindcss/types/config.js'
...
const plugins: PluginCreator = ({ addUtilities, matchUtilities, theme }) => {
    ...
    matchUtilities({ 'animate-delay': (value) => ({ animationDelay: value }) }, { values: theme('animationDelay') as KeyValuePair })
